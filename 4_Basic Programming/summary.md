...
pada task ini, buat program yang memunculkan output seperti dibawah, output merupakan tabel perkalian seperti yang dideskripsikan !
> input : 9  
output :  
1   2   3   4   5   6   7   8   9  
...
[tabelPerkalian.go](./praktikum/8_tabelPerkalian/tabelPerkalian.go)

Hasil kode program :

<img src="./screenshots/8_tabel_perkalian.jpg" width="900">